...
use mazze_parameters::{
    consensus::ONE_MAZZE_IN_MAZZY, genesis::DEV_GENESIS_KEY_PAIR, staking::*,
};
...
fn kill_account_with_checkpoints() {
    ...
    state_0
        .new_contract_with_code(&a_s, *COLLATERAL_MAZZIES_PER_STORAGE_KEY)
        .unwrap();
    state_0
...
fn check_result_of_simple_payment_to_killed_account() {
    ...
    state_0
        ...
        .unwrap()
        .add_balance(&ONE_MAZZE_IN_MAZZY.into());
    let mut a = Address::zero();
    a.set_contract_type_bits();
    let a_s = a.with_native_space();
...
//             required: *COLLATERAL_MAZZIES_PER_STORAGE_KEY * U256::from(2),
//             got: *COLLATERAL_MAZZIES_PER_STORAGE_KEY,
//         }
//     );
