...
use mazze_vm_types::{CreateContractAddress, Env, Spec};
...
pub fn contract_address(
    ...
    let (mut address, code_hash) = mazze_vm_types::contract_address(
        address_scheme,
        block_number,
        &sender.address,
        nonce,
...
pub mod test_util {
    ...
    use mazze_statedb::Result as DbResult;
    use mazze_vm_interpreter::FinalizationResult;
    use mazze_vm_types::{self as vm, ActionParams};
