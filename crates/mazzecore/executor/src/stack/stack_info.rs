use mazze_parameters::internal_contract_addresses::ADMIN_CONTROL_CONTRACT_ADDRESS;
use mazze_types::{AddressSpaceUtil, AddressWithSpace};
...
mod tests {
    ...
    use mazze_types::{Address, AddressSpaceUtil, AddressWithSpace};
