...
impl PackingPoolTransaction for MockTransaction {
    ...
    fn nonce(&self) -> mazze_types::U256 { self.nonce.into() }

    fn gas_price(&self) -> mazze_types::U256 { self.gas_price.into() }

    fn gas_limit(&self) -> mazze_types::U256 { self.gas_limit.into() }
}
