...
use mazze_internal_common::ChainIdParamsOneChainInner;
use mazze_types::{H160, H256};
...
error_chain! {
    links {
        ...
        StateDb(mazze_statedb::Error, mazze_statedb::ErrorKind);
        Storage(mazze_storage::Error, mazze_storage::ErrorKind);
    }
