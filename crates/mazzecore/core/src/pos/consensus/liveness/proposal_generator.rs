...
impl ProposalGenerator {
    ...
    pub async fn generate_proposal(
            ...
            .has_reconfiguration()
        {
            ...
            // the latest main decision.
            let parent_decision = parent_block
                .block_info()
                .main_decision()
                .cloned()
                .unwrap_or_default();
            let new_main_decision =
            ...
            match new_main_decision {
                Some(me_decision) => {
                    ...
                    diem_debug!(
                        ...
                        staking_events, parent_block.block_info().main_decision(), payload.last()
                    );
                ...
                None => {
                    warn!("pos progress without new main decision");
                }
            }
