...
impl QuorumCert {
    ...
    pub fn certificate_for_genesis_from_ledger_info(
        ...
        let ancestor = BlockInfo::new(
            ...
            None,
            ledger_info.main_decision().cloned(),
        );
    ...
    pub fn verify(&self, validator: &ValidatorVerifier) -> anyhow::Result<()> {
        ...
        // Genesis's QC is implicitly agreed upon, it doesn't have real
        // signatures. If someone sends us a QC on a fake genesis, it'll
        // fail to insert into BlockStore because of the round
        // constraint.
