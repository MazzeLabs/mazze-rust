...
fn block_forest_from_keys(
    ...
    // significantly larger trees than desired (this is my understanding
    // after reading the documentation: https://docs.rs/proptest/0.3.0/proptest/strategy/trait.Strategy.html#method.prop_recursive)
...
pub fn placeholder_certificate_for_block(
    ...
    // This ledger info doesn't carry any meaningful information: it is all
    // zeros except for the consensus data hash that carries the actual
    // vote.
