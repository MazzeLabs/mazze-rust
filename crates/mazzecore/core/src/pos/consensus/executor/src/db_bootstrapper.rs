...
use diem_types::{
    ...
    block_info::{
        BlockInfo, MainBlockDecision, GENESIS_EPOCH, GENESIS_ROUND,
...
pub fn generate_waypoint<V: VMExecutor>(
    ...
    // genesis ledger info (including main decision) is not used.
...
pub fn maybe_bootstrap<V: VMExecutor>(
    ...
    genesis_main_decision: Option<MainBlockDecision>, initial_seed: Vec<u8>,
