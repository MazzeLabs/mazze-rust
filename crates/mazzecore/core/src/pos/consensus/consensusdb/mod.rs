...
impl ConsensusDB {
    ...
    /// Save staking events between two main decisions.
    pub fn get_staking_events(
        &self, parent_decision: MainBlockDecision,
        me_decision: MainBlockDecision,
    ...
    /// committed a PoS block that processes this PoW main decision.
