...
//! These tests verify the behavior of BCS against some known test vectors with
//! various types.
...
fn test_access_path_canonical_serialization_example() {
    let account_address = AccountAddress::new([
        0x9a, 0x1a, 0xd0, 0x97, 0x42, 0xd1, 0xff, 0xc6, 0x2e, 0x65, 0x9e, 0x9a,
        0x77, 0x97, 0x80, 0x8b, 0x9a, 0x1a, 0xd0, 0x97, 0x42, 0xd1, 0xff, 0xc6,
        0x2e, 0x65, 0x9e, 0x9a, 0x77, 0x97, 0x80, 0x8b,
    ]);
    let input = AccessPath::new(
        account_address,
        vec![
            0x01, 0x21, 0x7d, 0xa6, 0xc6, 0xb3, 0xe1, 0x9f, 0x18, 0x25, 0xcf,
            0xb2, 0x67, 0x6d, 0xae, 0xcc, 0xe3, 0xbf, 0x3d, 0xe0, 0x3c, 0xf2,
            0x66, 0x47, 0xc7, 0x8d, 0xf0, 0x0b, 0x37, 0x1b, 0x25, 0xcc, 0x97,
        ],
    );
    ...
    let expected_output = vec![
        0x9a, 0x1a, 0xd0, 0x97, 0x42, 0xd1, 0xff, 0xc6, 0x2e, 0x65, 0x9e, 0x9a,
        0x77, 0x97, 0x80, 0x8b, 0x9A, 0x1A, 0xD0, 0x97, 0x42, 0xD1, 0xFF, 0xC6,
        0x2E, 0x65, 0x9E, 0x9A, 0x77, 0x97, 0x80, 0x8B, 0x21, 0x01, 0x21, 0x7D,
        0xA6, 0xC6, 0xB3, 0xE1, 0x9F, 0x18, 0x25, 0xCF, 0xB2, 0x67, 0x6D, 0xAE,
        0xCC, 0xE3, 0xBF, 0x3D, 0xE0, 0x3C, 0xF2, 0x66, 0x47, 0xC7, 0x8D, 0xF0,
        0x0B, 0x37, 0x1B, 0x25, 0xCC, 0x97,
    ];
...
fn test_transaction_payload_with_a_write_set_canonical_serialization_example() {
    let input = TransactionPayload::WriteSet(WriteSetPayload::Direct(
        ChangeSet::new(get_common_write_set(), vec![]),
    ));

    let expected_output = vec![
        0, 0, 2, 167, 29, 118, 250, 162, 210, 213, 195, 34, 78, 195, 212, 29,
        235, 41, 57, 167, 29, 118, 250, 162, 210, 213, 195, 34, 78, 195, 212,
        29, 235, 41, 57, 33, 1, 33, 125, 166, 198, 179, 225, 159, 24, 37, 207,
        178, 103, 109, 174, 204, 227, 191, 61, 224, 60, 242, 102, 71, 199, 141,
        240, 11, 55, 27, 37, 204, 151, 0, 196, 198, 63, 128, 199, 75, 17, 38,
        62, 66, 30, 191, 132, 134, 164, 227, 196, 198, 63, 128, 199, 75, 17,
        38, 62, 66, 30, 191, 132, 134, 164, 227, 9, 1, 33, 125, 166, 198, 179,
        225, 159, 24, 1, 4, 202, 254, 208, 13, 0,
    ];
...
fn test_write_set_canonical_serialization_example() {
    ...
    let expected_output = vec![
        0x02, 0xA7, 0x1D, 0x76, 0xFA, 0xA2, 0xD2, 0xD5, 0xC3, 0x22, 0x4E, 0xC3,
        0xD4, 0x1D, 0xEB, 0x29, 0x39, 0xA7, 0x1D, 0x76, 0xFA, 0xA2, 0xD2, 0xD5,
        0xC3, 0x22, 0x4E, 0xC3, 0xD4, 0x1D, 0xEB, 0x29, 0x39, 0x21, 0x01, 0x21,
        0x7D, 0xA6, 0xC6, 0xB3, 0xE1, 0x9F, 0x18, 0x25, 0xCF, 0xB2, 0x67, 0x6D,
        0xAE, 0xCC, 0xE3, 0xBF, 0x3D, 0xE0, 0x3C, 0xF2, 0x66, 0x47, 0xC7, 0x8D,
        0xF0, 0x0B, 0x37, 0x1B, 0x25, 0xCC, 0x97, 0x00, 0xC4, 0xC6, 0x3F, 0x80,
        0xC7, 0x4B, 0x11, 0x26, 0x3E, 0x42, 0x1E, 0xBF, 0x84, 0x86, 0xA4, 0xE3,
        0xC4, 0xC6, 0x3F, 0x80, 0xC7, 0x4B, 0x11, 0x26, 0x3E, 0x42, 0x1E, 0xBF,
        0x84, 0x86, 0xA4, 0xE3, 0x09, 0x01, 0x21, 0x7D, 0xA6, 0xC6, 0xB3, 0xE1,
        0x9F, 0x18, 0x01, 0x04, 0xCA, 0xFE, 0xD0, 0x0D,
    ];
    let actual_output = to_bytes(&input).unwrap();
    assert_eq!(expected_output, actual_output);
}
...
fn get_common_write_set() -> WriteSet {
    WriteSetMut::new(vec![
        (
            AccessPath::new(
                AccountAddress::new([
                    0xa7, 0x1d, 0x76, 0xfa, 0xa2, 0xd2, 0xd5, 0xc3, 0x22, 0x4e,
                    0xc3, 0xd4, 0x1d, 0xeb, 0x29, 0x39, 0xa7, 0x1d, 0x76, 0xfa,
                    0xa2, 0xd2, 0xd5, 0xc3, 0x22, 0x4e, 0xc3, 0xd4, 0x1d, 0xeb,
                    0x29, 0x39,
                ]),
                vec![
                    0x01, 0x21, 0x7d, 0xa6, 0xc6, 0xb3, 0xe1, 0x9f, 0x18, 0x25,
                    0xcf, 0xb2, 0x67, 0x6d, 0xae, 0xcc, 0xe3, 0xbf, 0x3d, 0xe0,
                    0x3c, 0xf2, 0x66, 0x47, 0xc7, 0x8d, 0xf0, 0x0b, 0x37, 0x1b,
                    0x25, 0xcc, 0x97,
                ],
            ),
            WriteOp::Deletion,
        ...
        (
            AccessPath::new(
                AccountAddress::new([
                    0xc4, 0xc6, 0x3f, 0x80, 0xc7, 0x4b, 0x11, 0x26, 0x3e, 0x42,
                    0x1e, 0xbf, 0x84, 0x86, 0xa4, 0xe3, 0xc4, 0xc6, 0x3f, 0x80,
                    0xc7, 0x4b, 0x11, 0x26, 0x3e, 0x42, 0x1e, 0xbf, 0x84, 0x86,
                    0xa4, 0xe3,
                ]),
