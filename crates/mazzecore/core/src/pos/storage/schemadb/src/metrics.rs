...
pub static DIEM_SCHEMADB_ITER_LATENCY_SECONDS: Lazy<HistogramVec> =
    Lazy::new(|| {
...
pub static DIEM_SCHEMADB_GET_LATENCY_SECONDS: Lazy<HistogramVec> =
    Lazy::new(|| {
        register_histogram_vec!(
            // metric name
...
pub static DIEM_SCHEMADB_BATCH_COMMIT_LATENCY_SECONDS: Lazy<HistogramVec> =
    Lazy::new(|| {
        register_histogram_vec!(
            // metric name
...
pub static DIEM_SCHEMADB_BATCH_COMMIT_BYTES: Lazy<HistogramVec> =
    Lazy::new(|| {
        register_histogram_vec!(
            // metric name
