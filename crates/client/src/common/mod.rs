...
use mazzekey::public_to_address;
...
use crate::{
    ...
    rpc::{
        ...
        impls::{
            mazze::RpcImpl, common::RpcImpl as CommonRpcImpl,
...
pub mod client_methods {
    ...
    /// Most Mazze components references block data manager.
...
> {
    ...
    if conf.is_dev_mode() {
        ...
        // receiving RPC `mazze_sendRawTransaction`.
