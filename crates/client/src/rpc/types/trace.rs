...
use mazze_execute_helper::exec_tracer::{
...
pub struct EpochTrace {
    mazze_traces: Vec<LocalizedTrace>,
...
impl EpochTrace {
    pub fn new(
        mazze_traces: Vec<LocalizedTrace>, eth_traces: Vec<EthLocalizedTrace>,
    ) -> Self {
        let mut mirror_address_map = HashMap::new();
        for t in &mazze_traces {
