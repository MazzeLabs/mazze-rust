    ...
    pub fn into_primitive(self) -> Result<PrimitiveBlock, RpcError> {
        let miner: H160 = match self.miner.try_into() {
            ...
            Err(_) => bail!(RpcError::invalid_params(
                "Invalid params: expected a valid base32-encoded Mazze address",
            )),
        };
...
mod tests {
    ...
    fn test_serialize_block() {
        let block = Block {
            ...
            deferred_logs_bloom_hash: mazze_types::KECCAK_EMPTY_BLOOM.into(),
            blame: 0.into(),
