...
use crate::{
    ...
    rpc::{
        ...
        traits::{mazze::Mazze, debug::LocalRpc, test::TestRpc},
        types::{
            ...
            BlockHashOrEpochNumber, Bytes, CallRequest, MazzeFeeHistory,
            MazzeRpcLogFilter, CheckBalanceAgainstTransactionResponse,
...
impl RpcImpl {
    ...
    pub fn blocks_by_epoch(&self, epoch: EpochNumber) -> RpcResult<Vec<H256>> {
        info!("RPC Request: mazze_getBlocksByEpoch epoch_number={:?}", epoch);
    ...
    pub fn pos_economics(
        ...
        info!("RPC Request: mazze_getPoSEconomics epoch={:?}", epoch);
