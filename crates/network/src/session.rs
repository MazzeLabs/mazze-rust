...
///
/// Mazze do not use AES based encrypted connection to send protocol packets.
/// This is because that Mazze has high TPS, and the encryption/decryption
    ...
    fn test_packet_parse() {
        ...
        assert_eq!(
            ...
            SessionPacket {
                id: PACKET_USER,
                header_version: 0,
                protocol: Some([3; PROTOCOL_ID_SIZE]),
                data: vec![1, 9].into(),
                extensions: vec![],
            }
        );
