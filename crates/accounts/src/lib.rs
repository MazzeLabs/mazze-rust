...
use mazzekey::{Address, Generator, Message, Password, Public, Random, Secret};
use mazzestore::{
    accounts_dir::MemoryDirectory, random_string, MazzeMultiStore, MazzeStore,
...
pub use mazzekey::Signature;
pub use mazzestore::{Derivation, Error, IndexDerivation, KeyFile};
...
pub struct AccountProvider {
    ...
    transient_sstore: MazzeMultiStore,
...
fn transient_sstore() -> MazzeMultiStore {
...
mod tests {
    ...
    use mazzekey::{Address, Generator, Random};
    use mazzestore::{Derivation, StoreAccountRef};
