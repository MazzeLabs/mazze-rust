...
pub fn import_account(
    path: &Path, dst: &dyn KeyDirectory,
...
pub fn import_accounts(
    src: &dyn KeyDirectory, dst: &dyn KeyDirectory,
...
/// Provide a `HashSet` of all accounts available for import from the Geth
/// keystore.
...
pub fn import_geth_accounts(
    dst: &dyn KeyDirectory, desired: HashSet<Address>, testnet: bool,
) -> Result<Vec<Address>, Error> {
